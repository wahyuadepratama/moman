      ...
      <div class=""><!-- <div class="main-panel"> -->
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <style media="screen">
            .fund {position: absolute; left: 0;right: 0;margin-left: auto;margin-right: auto;width: 350px;text-align: center;top: 45px;font-size: 25px;border-radius: 5%;color: white;padding-left: 5px;padding-right: 10px;}
                  ...
                  <div class="card bg-gradient-white card-img-holder text-grey">
                    <div class="card-body" style="padding: 5% !important">
                      ...
                      <h6 class="font-weight-bold mb-3">
                        <i class="mdi mdi-account-multiple-outline text-success mdi-24px float-right"></i> <?= $d->name ?>
                      </h6>
                    </div>
                  </div>
                  <div class="card">
