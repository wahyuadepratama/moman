...
<head>
  ...
  <body class="text-center" onload="loading()">
    <form class="form-signin" method="post" action="<?php $this->url('login/store') ?>">
      <?php $this->csrf_field() ?>
      ...
      <a href="<?php $this->url('register') ?>" class="btn btn-sm btn-success btn-block" type="submit">Register</a>
