      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="page-header">
            ...
            <a href="#" data-toggle="modal" data-target="#add_tpa" class="btn btn-gradient-danger btn-sm">+ Add TPA Data</a>
            <!-- Modal Avatar -->
            <div class="modal fade" id="add_tpa" tabindex="-1" role="dialog" aria-labelledby="avatar" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <form action="<?php $this->url('stewardship/recipient/tpa/store') ?>" method="post">

                  <?php $this->csrf_field() ?>

                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="avatar">New TPA Data</h5>
                        ...
                        <tbody style="text-align:center">
                          <?php foreach ($tpa as $p): ?>
                            <tr>
                              ...
                              <td><?= $p->address ?></td>
                              <td>
                                <a href="#" data-toggle="modal" data-target="#edit_tpa<?= $p->id ?>" class="btn btn-sm btn-success">Edit</a>
                                <!-- Modal Avatar -->
                                <div class="modal fade" id="edit_tpa<?= $p->id ?>" tabindex="-1" role="dialog" aria-labelledby="avatar" aria-hidden="true">
                                  <div class="modal-dialog" role="document">
                                    <form action="<?php $this->url('stewardship/recipient/tpa/update?id='. $p->id) ?>" method="post">

                                      <?php $this->csrf_field() ?>

                                      <div class="modal-content">
                                        <div class="modal-header">
                                          <h5 class="modal-title" id="avatar">Edit TPA Data</h5>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
