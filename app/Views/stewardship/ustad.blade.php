      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="page-header">
            ...
            <a href="#" data-toggle="modal" data-target="#add_ustad" class="btn btn-gradient-danger btn-sm">+ Add Ustad Data</a>
            <!-- Modal Avatar -->
            <div class="modal fade" id="add_ustad" tabindex="-1" role="dialog" aria-labelledby="avatar" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <form action="<?php $this->url('stewardship/recipient/ustad/store') ?>" method="post">

                  <?php $this->csrf_field() ?>

                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="avatar">New Ustad Data</h5>
                          ...
                          <?php foreach ($ustad as $p): ?>
                            <tr>
                              ...
                              <td>
                                ...
                                <!-- Modal Avatar -->
                                <div class="modal fade" id="edit_ustad<?= $p->id ?>" tabindex="-1" role="dialog" aria-labelledby="avatar" aria-hidden="true">
                                  <div class="modal-dialog" role="document">
                                    <form action="<?php $this->url('stewardship/recipient/ustad/update?id='. $p->id) ?>" method="post">

                                      <?php $this->csrf_field() ?>

                                      <div class="modal-content">
                                        <div class="modal-header">
                                          <h5 class="modal-title" id="avatar">Edit Ustad Data</h5>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
