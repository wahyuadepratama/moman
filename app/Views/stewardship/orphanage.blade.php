      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="page-header">
            ...
            <a href="#" data-toggle="modal" data-target="#add_orphanage" class="btn btn-gradient-danger btn-sm">+ Add Orphanage Data</a>
            <!-- Modal Avatar -->
            <div class="modal fade" id="add_orphanage" tabindex="-1" role="dialog" aria-labelledby="avatar" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <form action="<?php $this->url('stewardship/recipient/orphanage/store') ?>" method="post">

                  <?php $this->csrf_field() ?>

                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="avatar">New Orphanage Data</h5>
                    ...
                    <div class="col-md-12 table-responsive">
                      <table class="table" id="data">
                        ...
                        <tbody style="text-align:center">
                          <?php foreach ($orphanage as $p): ?>
                            <tr>
                              <td>#<?= $p->id ?></td>
                              <td><?= $p->name ?></td>
                              <td><?= $p->address ?></td>
                              <td>
                                <a href="#" data-toggle="modal" data-target="#edit_orphanage<?= $p->id ?>" class="btn btn-sm btn-success">Edit</a>
                                <!-- Modal Avatar -->
                                <div class="modal fade" id="edit_orphanage<?= $p->id ?>" tabindex="-1" role="dialog" aria-labelledby="avatar" aria-hidden="true">
                                  <div class="modal-dialog" role="document">
                                    <form action="<?php $this->url('stewardship/recipient/orphanage/update?id='. $p->id) ?>" method="post">

                                      <?php $this->csrf_field() ?>

                                      <div class="modal-content">
                                        <div class="modal-header">
                                          <h5 class="modal-title" id="avatar">Edit Orphanage Data</h5>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
