                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12" style="text-align:center;">
                      ...
                      <img src="<?php $this->url('images/waiting.gif') ?>">
                      <h3>Donation Confirmation</h3><br>
                      <h3>Rp <?= number_format(($donation),0,',','.') ?></h3><br>
                      <h4>Transfer your donation via <?= $mosque ?> Bank Account</h4>
                      ...
                      <a href="<?php $this->url('jamaah/history') ?>" class="btn btn-md btn-success">Check Invoice After Payment</a>
                    </div>
                  </div>
                </div>
              </div>
